...
public:
    ...
    PauseMenu(){
        ...
        models["1resumeGameButton"]->onClick = [this]() {Scene::activeScene = "World" ;};
        ...
        models["2settingsButton"]->onClick = [this]() {Scene::activeScene = "Settings";};
        ...
        models["3quitGameButton"]->onClick = [this]() {Scene::activeScene = "MainMenu";};

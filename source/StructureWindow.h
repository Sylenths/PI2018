...
//        modelsSideWindow["1CartonLabelDesc"] = new TextWindow(ResourceManager::getInstance()->getResource<Font*>("font - arial32")->getFont(), {128,128,128,0}, Materiel::carton->getDescription() , 1110, 440, 0, 135, 300, modelsSideWindow["1CartonIcon"]);

...
public:
    ...
    StructureWindow(){
        ...
        storyAmount = 0;
        height.push_back(1);
        modelsSideWindow["SideMenuStructure"] = new Image("SideMenuStructure", 920, 0, 0, 360, 720, EntityManager::get<Texture2d*>("StructureWindow")->getID());
        ...
        //type de matérieux
        modelsSideWindow["1CartonIcon"] = new CheckBox ("1CartonIcon", 940, 205, 0, 50, 50, EntityManager::get<Texture2d*>("ChoixNonAppuyer")->getID(), EntityManager::get<Texture2d*>("ChoixAppuyer")->getID());
        ...
        modelsSideWindow["1BoisIcon"] = new CheckBox ("1BoisIcon", 1010, 205, 0, 50, 50, EntityManager::get<Texture2d*>("ChoixNonAppuyer")->getID(), EntityManager::get<Texture2d*>("ChoixAppuyer")->getID());
        ...
        modelsSideWindow["1PierreIcon"] = new CheckBox ("1PierreIcon", 1080, 205, 0, 50, 50, EntityManager::get<Texture2d*>("ChoixNonAppuyer")->getID(), EntityManager::get<Texture2d*>("ChoixAppuyer")->getID());
        ...
        modelsSideWindow["1MetalIcon"] = new CheckBox ("1MetalIcon", 1150, 205, 0, 50, 50, EntityManager::get<Texture2d*>("ChoixNonAppuyer")->getID(), EntityManager::get<Texture2d*>("ChoixAppuyer")->getID());
        ...
        modelsSideWindow["1SIMTiumIcon"] = new CheckBox ("1SIMTiumIcon", 1220, 205, 0, 50, 50, EntityManager::get<Texture2d*>("ChoixNonAppuyer")->getID(), EntityManager::get<Texture2d*>("ChoixAppuyer")->getID());
        ...
        //Building Button
        modelsSideWindow["1BuildingButtonStructure"] = new Button ("1BuildingButtonStructure", 930, 580, 0, 340, 60, EntityManager::get<Texture2d*>("BuildButton")->getID(), EntityManager::get<Texture2d*>("BuildButtonOver")->getID());
        modelsSideWindow["1BuildingButtonStructure"]->onClick = [this] () {onBuildClick();};

        modelsSideWindow["1CancelButtonStructure"] = new Button ("1CancelButtonStructure", 930, 650, 0, 340, 60, EntityManager::get<Texture2d*>("CancelButton")->getID(), EntityManager::get<Texture2d*>("CancelButtonOver")->getID());

...
public:
    /// Constructeur
    MainMenu(){
        models["FondMaison"] = new Image("FondMaison", 0, 0, 0, 1280, 720, EntityManager::get<Texture2d*>("FondMaison")->getID());

        models["ButtonStart"] = new Button ("ButtonStart", 967, 50, 0, 298, 128, EntityManager::get<Texture2d*>("ButtonStartOver")->getID(), EntityManager::get<Texture2d*>("ButtonStart")->getID());
        models["ButtonStart"]->onClick = [this]() { Scene::changeActiveScene("World"); };

        models["ButtonSettings"] = new Button("ButtonSettings", 967, 225, 0, 298, 128, EntityManager::get<Texture2d*>("ButtonSettingsOver")->getID(), EntityManager::get<Texture2d*>("ButtonSettings")->getID());
        models["ButtonSettings"]->onClick = [this]() { Scene::changeActiveScene("SettingsMenu"); };

        models["ButtonHighScore"] = new Button("ButtonHighScore", 967, 400, 0, 298, 128, EntityManager::get<Texture2d*>("ButtonHighScoreOver")->getID(), EntityManager::get<Texture2d*>("ButtonHighScore")->getID());
        models["ButtonHighScore"]->onClick = [this]() { Scene::changeActiveScene("HighScoresMenu"); };

        models["ButtonQuitGame"] = new Button("ButtonQuitGame", 967, 575, 0, 298, 128, EntityManager::get<Texture2d*>("ButtonQuitGame")->getID(), EntityManager::get<Texture2d*>("ButtonQuitGameOver")->getID());

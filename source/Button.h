...
public:
    ...
    Button(const std::string name, double x, double y, double z, double width, double height, unsigned int defaultTextureID, unsigned int mouseOverTextureID = 0) : Image(name, x, y, z, width, height, defaultTextureID) {

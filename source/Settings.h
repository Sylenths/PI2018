...
public:
    Settings() {
        leftArrowButton = new Button ( onClick, ResourceManager::getInstance()->getTexture("ButtonLeftArrow"), 800, 543, 0, 100, 100);
        ResourceManager::getInstance()->addResource("ButtonLeftArrow", leftArrowButton);
        rightArrowButton = new Button ( onClick, ResourceManager::getInstance()->getTexture("ButtonRightArrow"), 950, 543, 0, 100, 100);
        ResourceManager::getInstance()->addResource("ButtonRightArrow", rightArrowButton);
        FPSButton = new Button ( onClick, ResourceManager::getInstance()->getTexture("ButtonFPS"), 800, 343, 0, 298, 128);
        ResourceManager::getInstance()->addResource("ButtonFPS", FPSButton);
        backButton = new Button ( onClick, ResourceManager::getInstance()->getTexture("ButtonBack"), 640, 143, 0, 298, 128);
